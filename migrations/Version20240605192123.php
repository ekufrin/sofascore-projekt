 ...
 */
final class Version20240605192123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE player_event (player_id INT NOT NULL, event_id INT NOT NULL, PRIMARY KEY(player_id, event_id))');
        ...
        $this->addSql('ALTER TABLE player_event ADD CONSTRAINT FK_84DC71E199E6F5DF FOREIGN KEY (player_id) REFERENCES player (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE player_event ADD CONSTRAINT FK_84DC71E171F7E88B FOREIGN KEY (event_id) REFERENCES event (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE player_event DROP CONSTRAINT FK_84DC71E199E6F5DF');
        $this->addSql('ALTER TABLE player_event DROP CONSTRAINT FK_84DC71E171F7E88B');
