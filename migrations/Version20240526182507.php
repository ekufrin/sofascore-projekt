 ...
 */
final class Version20240526182507 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT NOT NULL, tournament_id INT NOT NULL, home_team_id INT NOT NULL, away_team_id INT NOT NULL, home_score_id INT NOT NULL, away_score_id INT NOT NULL, slug VARCHAR(255) NOT NULL, start_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, round INT NOT NULL, status VARCHAR(255) NOT NULL, winner_code VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE incident (id INT NOT NULL, player_id INT NOT NULL, team_side VARCHAR(255) NOT NULL, color VARCHAR(255) NOT NULL, time INT NOT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE tournament (id INT NOT NULL, sport_id INT NOT NULL, country_id INT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
